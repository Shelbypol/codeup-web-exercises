...
var dayOfTheWeek = ['food1', 'food2', 'food3'];

// TODO: create an array of favorite foods and set to a variable called `favoriteFoods` - then console.log the variable
var favoriteFood = ['food1', 'food2', 'food3'];
...
// }
// console.log(returnLastElement(favoriteFood));
...
//     if(favoriteFood[i] === 'food2'){
//         alert('that is my fav food');
//         //can use break to stop
//     }
// }
...
// for(var i = 0; i < favoriteFood.length; i++){
//     console.log(favoriteFood[i]);
//     if(favoriteFood[i] === 'food3'){
//         alert('that my fav too');
//     }
// }
...
favoriteFood.forEach(function(element) {
    console.log(element);
    if(element === 'food3') {
        alert('Hey, i like that food');
    }
});
